...
namespace Ionascu_Adrian_Lab8.Models
{
    public class BookCategoriesPageModel: PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Ionascu_Adrian_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Ionascu_Adrian_Lab8Context context,
